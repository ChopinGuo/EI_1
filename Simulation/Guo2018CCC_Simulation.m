...
figure(1);
plot(0:T:T*(kmax-1),zeta2(1:Ord:length(zeta2))-zeta1(1:Ord:length(zeta1)), 'LineWidth', 2);
hold on;
plot(0:T:T*(kmax-1),zeta3(1:Ord:length(zeta3))-zeta1(1:Ord:length(zeta1)), 'LineWidth', 2);
hold on;
plot(0:T:T*(kmax-1),zeta4(1:Ord:length(zeta4))-zeta1(1:Ord:length(zeta1)), 'LineWidth', 2);
hold on;
plot(0:T:T*(kmax-1),zeta5(1:Ord:length(zeta5))-zeta1(1:Ord:length(zeta1)), 'LineWidth', 2);
hold on;
plot(0:T:T*(kmax-1),zeta6(1:Ord:length(zeta6))-zeta1(1:Ord:length(zeta1)), 'LineWidth', 2);
hold on;
plot(0:T:T*(kmax-1),zeta2(2:Ord:length(zeta2))-zeta1(2:Ord:length(zeta1)), 'LineWidth', 2);
hold on;
plot(0:T:T*(kmax-1),zeta3(2:Ord:length(zeta3))-zeta1(2:Ord:length(zeta1)), 'LineWidth', 2);
hold on;
plot(0:T:T*(kmax-1),zeta4(2:Ord:length(zeta4))-zeta1(2:Ord:length(zeta1)), 'LineWidth', 2);
hold on;
plot(0:T:T*(kmax-1),zeta5(2:Ord:length(zeta5))-zeta1(2:Ord:length(zeta1)), 'LineWidth', 2);
hold on;
plot(0:T:T*(kmax-1),zeta6(2:Ord:length(zeta6))-zeta1(2:Ord:length(zeta1)), 'LineWidth', 2);
hold on;
grid on;
...
figure(11);
plot(0:T:T*(kmax-1),zeta_hat1(1:Ord:length(zeta_hat1))-zeta1(1:Ord:length(zeta1)), 'LineWidth', 2);
hold on;
plot(0:T:T*(kmax-1),zeta_hat2(1:Ord:length(zeta_hat2))-zeta2(1:Ord:length(zeta2)), 'LineWidth', 2);
hold on;
plot(0:T:T*(kmax-1),zeta_hat3(1:Ord:length(zeta_hat3))-zeta3(1:Ord:length(zeta3)), 'LineWidth', 2);
hold on;
plot(0:T:T*(kmax-1),zeta_hat4(1:Ord:length(zeta_hat4))-zeta4(1:Ord:length(zeta4)), 'LineWidth', 2);
hold on;
plot(0:T:T*(kmax-1),zeta_hat5(1:Ord:length(zeta_hat5))-zeta5(1:Ord:length(zeta5)), 'LineWidth', 2);
hold on;
plot(0:T:T*(kmax-1),zeta_hat6(1:Ord:length(zeta_hat6))-zeta6(1:Ord:length(zeta6)), 'LineWidth', 2);
hold on;
plot(0:T:T*(kmax-1),zeta_hat1(2:Ord:length(zeta_hat1))-zeta1(2:Ord:length(zeta1)), 'LineWidth', 2);
hold on;
plot(0:T:T*(kmax-1),zeta_hat2(2:Ord:length(zeta_hat2))-zeta2(2:Ord:length(zeta2)), 'LineWidth', 2);
hold on;
plot(0:T:T*(kmax-1),zeta_hat3(2:Ord:length(zeta_hat3))-zeta3(2:Ord:length(zeta3)), 'LineWidth', 2);
hold on;
plot(0:T:T*(kmax-1),zeta_hat4(2:Ord:length(zeta_hat4))-zeta4(2:Ord:length(zeta4)), 'LineWidth', 2);
hold on;
plot(0:T:T*(kmax-1),zeta_hat5(2:Ord:length(zeta_hat5))-zeta5(2:Ord:length(zeta5)), 'LineWidth', 2);
hold on;
plot(0:T:T*(kmax-1),zeta_hat6(2:Ord:length(zeta_hat6))-zeta6(2:Ord:length(zeta6)), 'LineWidth', 2);
hold on;
grid on;
xlabel('time $(s)$','Interpreter','latex');
ylabel('$x_{i}-\hat x_{i}$','Interpreter','latex');
